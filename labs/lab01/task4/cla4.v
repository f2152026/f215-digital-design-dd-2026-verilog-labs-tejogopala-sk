...
module cla4(
  ...
  wire tc1_1;
  wire tc2_1, tc2_2;
  wire tc3_1, tc3_2, tc3_3;
  wire tc4_1, tc4_2, tc4_3, tc4_4;

//xor and and signal formation
...
//   c4 = g3 + p3.g2 + p3.p2.g1 + p3.p2.p1.g0 + p3.p2.p1.p0.cin
  ...
  and #(2) ac1_1(tc1_1, p0, cin);
  or #(2) oc1(c1, g0, tc1_1);

  and #(2) ac2_1(tc2_1, p1, p0, cin);
  and #(2) ac2_2(tc2_2, p1, g0); 
  or #(2) oc2(c2, tc2_1, tc2_2, g1);

  and #(2) ac3_1 (tc3_1, p2, g1);
  and #(2) ac3_2 (tc3_2, p2, p1, g0);
  and #(2) ac3_3 (tc3_3, p2, p1, p0, cin);
  or  #(2) oc3   (c3, g2, tc3_1, tc3_2, tc3_3);

  and #(2) ac4_1 (tc4_1, p3, g2);
  and #(2) ac4_2 (tc4_2, p3, p2, g1);
  and #(2) ac4_3 (tc4_3, p3, p2, p1, g0);
  and #(2) ac4_4 (tc4_4, p3, p2, p1, p0, cin);
  or  #(2) oc4   (cout, g3, tc4_1, tc4_2, tc4_3, tc4_4);
